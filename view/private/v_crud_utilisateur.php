...
<head>
    ...
    <title>Nautilus Social Manager - CRUD utilisateur</title>
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        if (isset($crud)) {
                            switch ($crud) {
                                case 'c':
                                    include "crud_utilisateur/create.php";
                                    break;
                                case 'u':
                                    include "crud_utilisateur/update.php";
                                    break;
                                case 'd':
                                    include "crud_utilisateur/delete.php";
                                    break;
                            }
                        } else {
                            include "crud_utilisateur/read+.php";        
                        }
                    ?>
                </div>
                <!-- /.container-fluid -->
