...
<head>
    ...
    <title>Nautilus - Connexion</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="images/logo.png" class="rounded my-4 img-fluid">
                                        <h1 class="h4 text-gray-900 mb-4">Bienvenue !</h1>
                                    </div>
                                    <form method="post" class="user" id="captcha">
                                        ...
                                        <button class="g-recaptcha btn btn-primary btn-user btn-block" name="submitConnexion" data-sitekey="6LeQn-EZAAAAAI-ScUYpCb3pPIC9ecFscMRZfFuZ" data-callback='onSubmit' data-action='submit' >Se connecter</button>
                                    </form>
                                    <?php
