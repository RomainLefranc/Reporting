                            ...
                            function (data, textStatus) {
                                switch (textStatus) {
                                    case 'success':
                                        ...
                                        /* var monUrl = 'https://graph.facebook.com/v4.0/' + idPageFB + '/insights/page_fans/day?&since=' + tabMois[0].dateSince + '&until=' + tabMois[2].dateUntil + '&access_token=' + tokenPageFB;               
                                        console.log(monUrl);
                                        $.ajax(                  
                                            {
                                            url : monUrl,
                                                                ...
                                                                complete :
                                                                    function(xhr, textStatus){
                                                                        ...
                                                                        if (typeof response.posts != "undefined") {
                                                                            ...
                                                                            $.ajax(
                                                                                {
                                                                                    url : `https://graph.facebook.com/v4.0/${idPage}/insights/page_fans_gender_age?since=${maDate2}&until=${maDate2}&access_token=${tokenPage}`,
                                                                                    complete :
                                                                                    function(xhr, textStatus){
                                                                                        var response = JSON.parse(xhr.responseText);
