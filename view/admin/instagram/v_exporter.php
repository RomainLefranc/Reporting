                        ...
                        $('#bilan').submit(function (e) { 
                            ...
                            $.get(`https://graph.facebook.com/v8.0/${idPageInsta}?fields=id,media{id,caption,like_count,media_type,comments_count,thumbnail_url,media_url,timestamp}&access_token=${token}`, function (data) {
                                ...
                                $.get(`https://graph.facebook.com/v4.0/${idPageInsta}/insights?metric=follower_count,reach,impressions&period=day&since=${dateSince}&until=${dateUntil}&access_token=${token}`, function (data) {
                                    ...
                                    var imgTop2Interaction = donneesPowerPoint.top3Interaction[1].media_url;
                                    var imgTop3Interaction = donneesPowerPoint.top3Interaction[2].media_url;

                                    var imgTop1Reach = donneesPowerPoint.top3ReachMois[0].media_url;
                                    var imgTop2Reach = donneesPowerPoint.top3ReachMois[1].media_url;
                                    var imgTop3Reach = donneesPowerPoint.top3ReachMois[2].media_url;

                                    var imgFlop1Reach = donneesPowerPoint.top3FlopReach[0].media_url;
                                    var imgFlop2Reach = donneesPowerPoint.top3FlopReach[1].media_url;
                                    var imgFlop3Reach = donneesPowerPoint.top3FlopReach[2].media_url;
