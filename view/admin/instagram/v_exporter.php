                ...
                <div class="container-fluid">
                    ...
                    <script>
                        ...
                        $('#bilan').submit(function (e) {
                            ...
                            nomMois = listeMois[mois.getMonth()];
                            ...
                            $.get(`https://graph.facebook.com/v8.0/${idPageInsta}?fields=id,media{id,caption,like_count,media_type,comments_count,thumbnail_url,media_url,timestamp}&access_token=${token}`, function (data) {
                                ...
                                if (nbMediaMensuel == 0) {
                                    ...
                                    $.get(`https://graph.facebook.com/v4.0/${idPageInsta}/insights?metric=follower_count,reach,impressions&period=day&since=${dateSince}&until=${dateUntil}&access_token=${token}`, function (data) {
                                        ...
                                        donneesPowerPoint.nbMedia = nbMediaMensuel;
                                                                                ...
                                                                                html2canvas(document.body).then(function(canvas) {
                                                                                    ...
                                                                                    domtoimage.toPng(node).then(function (dataUrl) {
                                                                                        domtoimage.toPng(node2).then(function (dataUrl2) {
                                                                                            ...
                                                                                            slide.addText('BILAN mensuel',  { x:'30%', y:'57%', w:4, color:'FFFFFF', align: 'center', fontFace:'Avenir 85 Heavy', fontSize:30 });
                                                                                            ...
                                                                                            slide.addText([
                                                                                                    { text:  donneesPowerPoint.nbMedia.toString(), options: {bold:true, fontSize:12}},
                                                                                                    { text: ' posts', options: {}}
                                                                                                ], { shape:pptx.shapes.RECTANGLE, align:'center', x:'45%', y:'80%', w:1, h:1, fill:'0088CC', line:'006699', lineSize:2 , fontSize:10, color:'FFFFFF'});
                                                                                            slide.addText([
                                                                                                    { text: donneesPowerPoint.totalInteraction.toString(), options: {bold:true, fontSize:12}},
                                                                                                    { text: ' interactions soit une moyenne de ', options: {}},
                                                                                                    { text: (totalInteractionMensuel/nbMediaMensuel).toFixed(0) + '/post', options: {bold:true}}
                                                                                                ], { shape:pptx.shapes.RECTANGLE, align:'center', x:'60%', y:'80%', w:1, h:1, fill:'0088CC', line:'006699', lineSize:2 , fontSize:10, color:'FFFFFF'});
                                                                                            slide.addText([
                                                                                                    { text: donneesPowerPoint.totalReach.toString(), options: {bold:true, fontSize:12}},
