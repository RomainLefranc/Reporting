            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id='bilan'>
                        ...
                        <div class="form-group row" >
                            <label for="example-date-input" class="col-lg-2 col-form-label">Date de debut</label>
                            <div class="col-lg-10">
                    ...
                    <script>
                        ...
                        $('#bilan').submit(function (e) { 
                            ...
                            var differenceDeTemp = date1.getTime() - date2.getTime();
                            var differenceDeTempEnNbJours =  differenceDeTemp / (1000 * 3600 * 24)

                            if (!(differenceDeTempEnNbJours > 30 && differenceDeTempEnNbJours < 94)) {
