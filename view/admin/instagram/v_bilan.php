                ...
                <div class="container-fluid">
                    ...
                    <script>
                        $('#bilan').submit(function (e) { 
                            ...
                            var url = `https://graph.facebook.com/v8.0/${idPageInsta}?fields=id,media{id,like_count,media_type,comments_count,thumbnail_url,media_url,timestamp}&access_token=${token}`;

                            if ($('#choixPageInsta').find('option:selected').data('nom') == '') {
